...
/// Performs calculation that wraps around on overflow..
pub trait WrappingOps:
    Sized + Copy + WrappingAdd + WrappingSub + WrappingNeg + WrappingMul + WrappingShl + WrappingShr
{
}

impl<T> WrappingOps for T where
    T: Sized
        + Copy
        + WrappingAdd
        + WrappingSub
